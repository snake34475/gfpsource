package com.gfp.app.mapConfigFun
{
   ...
   public class MapXML_ReapMaterial implements IMapConfigFun
   {
      ...
      public function MapXML_ReapMaterial()
      {
         super();
      }
      ...
      {
         var _loc2_:DailyActivityInfo = null;
         var _loc3_:int = 0;
         if(_animation.currentFrame == _animation.totalFrames)
         {
            ...
            removeAnimation();
            reap();
            _loc2_ = DailyActivityXMLInfo.getActivityById(_reapId);
            _loc3_ = int(_loc2_.rewardVect[0].id);
         }
      }
      ...
      private static function onGetMaterial(param1:SocketEvent) : void
      {
         ...
         var _loc4_:uint = uint(_loc2_.itemArr[_loc2_.itemArr.length - 1].itemID);
         updateRecord();
      }
