package com.gfp.app.mapProcess
{
   ...
   public class MapProcess_1138102 extends BaseMapProcess
   {
      
      private var _leftTime:LeftTimeUI;
      
      public function MapProcess_1138102()
      {
         super();
      }
      ...
      override protected function init() : void
      {
         ...
         ++ClientTempState.endlessTowerFirstLayer;
         MiniMap.instance.changeTitle(TollgateXMLInfo.getName(1381) + "第" + ClientTempState.endlessTowerFirstLayer + "层");
      ...
      {
         if(ClientTempState.endlessTowerFirstLayer > 9)
         {
