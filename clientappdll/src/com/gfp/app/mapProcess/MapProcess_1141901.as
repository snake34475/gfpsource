package com.gfp.app.mapProcess
{
   ...
   public class MapProcess_1141901 extends BaseMapProcess
   {
      ...
      public function MapProcess_1141901()
      {
         super();
      }
      ...
      {
         this._mc = _mapModel.libManager.getMovieClip("UI_RecordCntMc_1419");
         this._preDamageCount = ActivityExchangeTimesManager.getTimes(12081);
      ...
      {
         this._currentDamageCount = this._preDamageCount + Math.floor(200000000 - UserManager.getModelByRoleType(15118).info.hp);
