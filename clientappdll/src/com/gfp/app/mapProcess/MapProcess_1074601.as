package com.gfp.app.mapProcess
{
   ...
   public class MapProcess_1074601 extends BaseMapProcess
   {
      
      public function MapProcess_1074601()
      {
         super();
      }
      ...
      private function onWinner(param1:FightEvent) : void
      {
         ...
         TextAlert.show("恭喜小侠士获得了一个小时内经验翻倍祝福，抓紧时间体验吧！");
         ActivityExchangeTimesManager.updataTimesByOnce(1821);
      }
