package com.gfp.app.mapProcess
{
   ...
   public class MapProcess_1119801 extends BaseMapProcess
   {
      ...
      public function MapProcess_1119801()
      {
         super();
      }
      ...
      override protected function init() : void
      {
         ...
         UserManager.addEventListener(SkillEvent.SKILL_ACTION,this.onModelSkillHandler);
         this.resizePos();
      }
      ...
      private function onModelSkillHandler(param1:SkillEvent) : void
      {
         ...
         {
            this._txtInfoMc.notAttackMc.visible = true;
      ...
      override public function destroy() : void
      {
         ...
         UserManager.removeEventListener(SkillEvent.SKILL_ACTION,this.onModelSkillHandler);
