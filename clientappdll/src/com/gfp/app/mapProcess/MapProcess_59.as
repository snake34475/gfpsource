package com.gfp.app.mapProcess
{
   ...
   public class MapProcess_59 extends MapProcessAnimat
   {
      ...
      private var _tuduiPosArr:Array = [[292,532],[1069,602],[644,483]];
      ...
      private var _tuduiFlipIDArr:Array = [2247,2248,2249];
      
      private var _updateTimeID:int = 2260;
      
      private var _updateTuduiFlipID:int = 2250;
      ...
      {
         if(param1.taskID == 1882 && param1.proID == 0)
         {
         }
         TasksManager.addListener(TaskEvent.PRO_COMPLETE,this.onTaskProComplete);
         if(param1.taskID == 1899 && param1.proID == 0)
         {
            ModuleManager.turnModule(ClientConfig.getAppModule("Drinking"),"喝仙酒……");
         }
      }
      
      private function onTaskAccept(param1:TaskEvent) : void
      {
         if(param1.taskID == 1875)
         {
            CityMap.instance.tranToNpc(10003);
         }
         else if(param1.taskID == 1876)
         {
            if(ItemManager.getItemCount(1500697) < 1)
            {
               AlertManager.showSimpleAlarm("进入关卡需要：同心锁*1，小侠士物品不足。");
            }
            else
            {
               PveEntry.instance.enterTollgate(667);
            }
         }
         else if(param1.taskID == 1882)
         {
            TasksManager.dispatchActionEvent(TaskActionEvent.TASK_CUSTOM_FINISH,"1882_0");
         }
      }
      ...
      private function onTaskComplete(param1:TaskEvent) : void
      {
         if(param1.taskID == 1875)
         {
            CityMap.instance.tranToNpc(10066);
         }
         else if(param1.taskID == 1881 || param1.taskID == 1876)
         {
