package com.gfp.app.mapProcess
{
   ...
   public class MapProcess_1109101 extends BaseMapProcess
   {
      
      private var _totalTime:int = 120000;
      ...
      public function MapProcess_1109101()
      {
         super();
      }
      ...
      private function onDie(param1:UserEvent) : void
      {
         ...
         if(_loc2_.info.roleType >= 12207 && _loc2_.info.roleType <= 12224)
         {
            ++this._killLongNum;
         }
         this.updateView();
