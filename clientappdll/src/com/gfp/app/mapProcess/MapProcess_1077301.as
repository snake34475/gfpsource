package com.gfp.app.mapProcess
{
   ...
   public class MapProcess_1077301 extends BaseMapProcess
   {
      
      public function MapProcess_1077301()
      {
         super();
      }
      ...
      private function onWinner(param1:FightEvent) : void
      {
         ...
         ActivityExchangeTimesManager.updataTimesByOnce(2003);
         AnimatPlay.startAnimat("task1821_",2,false,0,0,false,true);
      }
