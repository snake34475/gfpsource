package com.gfp.app.mapProcess
{
   ...
   public class MapProcess_1110901 extends BaseMapProcess
   {
      ...
      public function MapProcess_1110901()
      {
         super();
      }
      ...
      private function onTan(param1:SocketEvent) : void
      {
         ...
         SwfCache.getSwfInfo(ClientConfig.getCartoon("Mi_Bao_Tip"),this.movieCallBack1);
         if(this.index >= 7 && this.index < 13)
         {
            SwfCache.getSwfInfo(ClientConfig.getCartoon("Mi_Bao_Tip"),this.movieCallBack2);
         }
         if(this.index == 14)
         {
            SwfCache.getSwfInfo(ClientConfig.getCartoon("Mi_Bao_Tip"),this.movieCallBack3);
         }
      }
      ...
      private function hideMov2() : void
      {
         ...
         TweenLite.to(this._mc2,1,{
            "alpha":0,
            "x":LayerManager.stageWidth - this._mc1.width >> 1,
      ...
      override public function destroy() : void
      {
         ...
         SwfCache.cancel(ClientConfig.getCartoon("Mi_Bao_Tip"),this.movieCallBack1);
         SwfCache.cancel(ClientConfig.getCartoon("Mi_Bao_Tip"),this.movieCallBack2);
         SwfCache.cancel(ClientConfig.getCartoon("Mi_Bao_Tip"),this.movieCallBack3);
      }
   }
}
