package com.gfp.app.mapProcess
{
   ...
   public class MapProcess_1077001 extends BaseMapProcess
   {
      
      public function MapProcess_1077001()
      {
         super();
      }
      ...
      private function onWinner(param1:FightEvent) : void
      {
         ...
         ActivityExchangeTimesManager.updataTimesByOnce(1983);
         AnimatPlay.startAnimat("task1817_",2,false,0,0,false,true);
      }
