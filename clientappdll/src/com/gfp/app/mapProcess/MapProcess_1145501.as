package com.gfp.app.mapProcess
{
   ...
   public class MapProcess_1145501 extends BaseMapProcess
   {
      ...
      public function MapProcess_1145501()
      {
         super();
      }
      ...
      override protected function init() : void
      {
         ...
         this._attackTipMc = _mapModel.libManager.getMovieClip("UI_AttackTip");
