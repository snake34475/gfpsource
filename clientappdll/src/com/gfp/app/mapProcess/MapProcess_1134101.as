package com.gfp.app.mapProcess
{
   ...
   public class MapProcess_1134101 extends BaseMapProcess
   {
      
      private var _strategyPanel:MovieClip;
      
      public function MapProcess_1134101()
      {
         super();
      }
      ...
      {
         this._strategyPanel.x = (LayerManager.stageWidth - this._strategyPanel.width) / 2 + 16;
         this._strategyPanel.y = 477;
      }
