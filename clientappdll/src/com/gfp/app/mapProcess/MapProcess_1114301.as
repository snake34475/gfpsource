package com.gfp.app.mapProcess
{
   ...
   public class MapProcess_1114301 extends BaseMapProcess
   {
      ...
      public function MapProcess_1114301()
      {
         super();
      }
      ...
      private function responseScore(param1:Event) : void
      {
         ...
         this._hasBuff = (_loc2_ & 2) == 2;
         if(this._hasBuff)
         {
            AlertManager.showSimpleAlarm("恭喜小侠士，幸运的获得了第五关专属BUFF，可在生存第五关中祝你一臂之力！”");
         }
      }
