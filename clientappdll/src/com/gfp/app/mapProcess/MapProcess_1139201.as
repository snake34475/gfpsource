package com.gfp.app.mapProcess
{
   ...
   public class MapProcess_1139201 extends BaseMapProcess
   {
      ...
      public function MapProcess_1139201()
      {
         super();
      }
      ...
      {
         this._mc = _mapModel.libManager.getMovieClip("UI_RecordCntMc_1392");
      ...
      private function onDpsHit(param1:UserEvent) : void
      {
         ...
         {
            this._totalHp += _loc2_.decHP / 10000;
         }
         this._mcNumber.setValue(this._totalHp);
      }
