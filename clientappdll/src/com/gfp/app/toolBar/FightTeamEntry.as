package com.gfp.app.toolBar
{
   ...
   public class FightTeamEntry
   {
      
      private static var _instance:FightTeamEntry;
      
      private var _mainUI:SimpleButton;
      
      public function FightTeamEntry()
      {
         super();
         this._mainUI = UIManager.getButton("ToolBar_FightTeam");
         ToolTipManager.add(this._mainUI,AppLanguageDefine.GET_AWARD_COLLECTION[14]);
      }
      
      public static function get instance() : FightTeamEntry
      {
         if(_instance == null)
         {
            _instance = new FightTeamEntry();
         }
         return _instance;
      }
      ...
      {
         ModuleManager.turnModule(ClientConfig.getAppModule("FightTeamsMemberListPanel"),"正在加载....",MainManager.actorInfo.fightTeamId);
      }
   }
}
