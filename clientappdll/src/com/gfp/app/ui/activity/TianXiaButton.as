package com.gfp.app.ui.activity
{
   ...
   public class TianXiaButton extends BaseActivitySprite
   {
      ...
      public function TianXiaButton(param1:ActivityNodeInfo)
      {
         super(param1);
         this._flagMc = _sprite["flagMc"];
         this._flagMc.stop();
         var _loc2_:Date = TimeUtil.getSeverDateObject();
         var _loc3_:Date = new Date(2017,3,15,13,0);
         var _loc4_:Date = new Date(2017,3,15,15,0);
         var _loc5_:Date = new Date(2017,3,15,18,50);
         var _loc6_:Date = new Date(2017,3,15,21,0);
         var _loc7_:Date = new Date(2017,3,16,12,50);
         var _loc8_:Date = new Date(2017,3,16,15,0);
