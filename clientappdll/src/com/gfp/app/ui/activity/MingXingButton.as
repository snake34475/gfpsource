package com.gfp.app.ui.activity
{
   ...
   public class MingXingButton extends BaseActivitySprite
   {
      ...
      public function MingXingButton(param1:ActivityNodeInfo)
      {
         super(param1);
         this._flagMc = _sprite["flagMc"];
         this._flagMc.stop();
         var _loc2_:Date = TimeUtil.getSeverDateObject();
         var _loc3_:Date = new Date(2017,3,21,19,0);
         var _loc4_:Date = new Date(2017,3,21,20,0);
         var _loc5_:Date = new Date(2017,3,22,13,30);
         var _loc6_:Date = new Date(2017,3,22,14,30);
         var _loc7_:Date = new Date(2017,3,23,13,30);
         var _loc8_:Date = new Date(2017,3,23,14,30);
         if(_loc2_.time > _loc3_.time && _loc2_.time < _loc4_.time && MainManager.actorInfo.lv >= 30)
         {
            this._needShow = true;
            this.handleHide(_loc4_.time - _loc2_.time);
         }
         else if(_loc2_.time > _loc5_.time && _loc2_.time < _loc6_.time && MainManager.actorInfo.lv >= 30)
         {
            this._needShow = true;
            this.handleHide(_loc6_.time - _loc2_.time);
         }
         else if(_loc2_.time > _loc7_.time && _loc2_.time < _loc8_.time && MainManager.actorInfo.lv >= 30)
         {
            this._needShow = true;
