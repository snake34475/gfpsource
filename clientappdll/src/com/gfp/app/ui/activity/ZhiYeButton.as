package com.gfp.app.ui.activity
{
   ...
   public class ZhiYeButton extends BaseActivitySprite
   {
      ...
      public function ZhiYeButton(param1:ActivityNodeInfo)
      {
         super(param1);
         this._flagMc = _sprite["flagMc"];
         this._flagMc.stop();
         var _loc2_:Date = TimeUtil.getSeverDateObject();
         var _loc3_:Date = new Date(2017,3,28,19,0);
         var _loc4_:Date = new Date(2017,3,28,20,0);
         var _loc5_:Date = new Date(2017,3,29,13,20);
         var _loc6_:Date = new Date(2017,3,29,14,30);
         var _loc7_:Date = new Date(2017,3,30,13,20);
         var _loc8_:Date = new Date(2017,3,30,14,30);
