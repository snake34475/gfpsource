package com.gfp.app.ui.activity
{
   ...
   public class TurnGodByClickButton extends BaseActivitySprite
   {
      ...
      public function TurnGodByClickButton(param1:ActivityNodeInfo)
      {
         super(param1);
      ...
      {
         return Boolean(super.executeShow()) && MainManager.roleType != 6 && MainManager.actorInfo.secondTurnBackType == 0;
      }
   }
}
