package com.gfp.app.task.storyAnimation
{
   ...
   public class StoryAnimationTask_10003_2 implements IStoryAnimation
   {
      ...
      public function StoryAnimationTask_10003_2()
      {
         super();
      }
      ...
      public function start() : void
      {
         ...
         AnimatPlay.startAnimat("StoryAnimationTask_10003_",2,false,231,133,false,true);
      }
      ...
      public function onFinish() : void
      {
         ...
         TasksManager.taskProComplete(10003,2);
      }
   }
}
