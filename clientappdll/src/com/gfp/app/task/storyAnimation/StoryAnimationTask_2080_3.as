package com.gfp.app.task.storyAnimation
{
   ...
   public class StoryAnimationTask_2080_3 implements IStoryAnimation
   {
      ...
      public function StoryAnimationTask_2080_3()
      {
         super();
      }
      ...
      {
         this._loader = new UILoader(ClientConfig.getCartoon("task2080_3"),LayerManager.topLevel,LoadingType.TITLE_AND_PERCENT,"正在加载任务动画...");
      ...
      public function onFinish() : void
      {
         ...
         NpcDialogController.showForNpc(10528);
         if(this._loader)
         {
