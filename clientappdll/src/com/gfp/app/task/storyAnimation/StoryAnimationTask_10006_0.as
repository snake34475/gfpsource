package com.gfp.app.task.storyAnimation
{
   ...
   public class StoryAnimationTask_10006_0 implements IStoryAnimation
   {
      
      public function StoryAnimationTask_10006_0()
      {
         super();
      }
      ...
      public function start() : void
      {
         ...
         AnimatPlay.startAnimat("StoryAnimationTask_10006_",1,false,0,0,false,true);
      }
      ...
      public function onFinishHandler(param1:AnimatEvent) : void
      {
         ...
         TasksManager.taskProComplete(10006,0);
      }
