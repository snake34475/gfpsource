package com.gfp.app.task.storyAnimation
{
   ...
   public class StoryAnimationTask_2082_1 implements IStoryAnimation
   {
      ...
      public function StoryAnimationTask_2082_1()
      {
         super();
      }
      ...
      {
         this._loader = new UILoader(ClientConfig.getCartoon("task2082_1"),LayerManager.topLevel,LoadingType.TITLE_AND_PERCENT,"正在加载任务动画...");
