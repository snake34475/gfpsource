package com.gfp.app.task.storyAnimation
{
   ...
   public class StoryAnimationTask_2080_4 implements IStoryAnimation
   {
      ...
      public function StoryAnimationTask_2080_4()
      {
         super();
      }
      ...
      {
         this._loader = new UILoader(ClientConfig.getCartoon("task2080_4"),LayerManager.topLevel,LoadingType.TITLE_AND_PERCENT,"正在加载任务动画...");
      ...
      public function onFinish() : void
      {
         ...
         TasksManager.taskComplete(2080);
         if(this._loader)
         {
