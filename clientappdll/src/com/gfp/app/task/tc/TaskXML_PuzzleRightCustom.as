package com.gfp.app.task.tc
{
   ...
   public class TaskXML_PuzzleRightCustom extends TaskXML_Base
   {
      
      private var _conditionNum:uint;
      
      public function TaskXML_PuzzleRightCustom()
      {
         super();
      }
      ...
      override public function setup(param1:uint, param2:uint, param3:String, param4:Boolean) : void
      {
         ...
         var _loc5_:String = Logger.createLogMsgByArr("TaskXML_PuzzleRightCustom setup:",_params,param1,param2);
      ...
      {
         TasksManager.addActionListener(TaskActionEvent.TASK_PUZZLE_RIGHT_CUSTOM,"",this.onPuzzleRight);
      }
      ...
      {
         TasksManager.removeActionListener(TaskActionEvent.TASK_PUZZLE_RIGHT_CUSTOM,"",this.onPuzzleRight);
      }
