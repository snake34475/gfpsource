package com.gfp.app.task.tc
{
   ...
   public class TaskXML_TollgateGrade extends TaskXML_Base
   {
      ...
      public function TaskXML_TollgateGrade()
      {
         super();
      }
      ...
      override public function setup(param1:uint, param2:uint, param3:String, param4:Boolean) : void
      {
         ...
         var _loc5_:String = Logger.createLogMsgByArr("TaskXML_TollgateGrade setup:",_params,param1,param2);
         Logger.info(this,_loc5_);
         var _loc6_:Array = param3.split("|");
         if(_loc6_.length >= 2)
         {
            this._tollgateId = uint(_loc6_[0]);
            this._grade = uint(_loc6_[1]);
         }
      }
      ...
      private function onTollgatePassed(param1:TaskActionEvent) : void
      {
         ...
         if((this._tollgateId == 0 || this._tollgateId == _loc2_.stageId) && _loc2_.grade >= this._grade)
         {
