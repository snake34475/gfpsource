package com.gfp.app.task.tc
{
   ...
   public class TaskXML_PvpWin extends TaskXML_Base
   {
      ...
      public function TaskXML_PvpWin()
      {
         super();
      }
      ...
      override public function setup(param1:uint, param2:uint, param3:String, param4:Boolean) : void
      {
         ...
         var _loc5_:String = Logger.createLogMsgByArr("TaskXML_PvpWin setup:",_params,param1,param2);
