package com.gfp.app.arrowTip
{
   ...
   public class RunDirectionArrow extends Sprite
   {
      
      private static var _instance:RunDirectionArrow;
      
      private var _mainUI:Sprite;
      
      private var _effict:MovieClip;
      
      public function RunDirectionArrow()
      {
         super();
         this._mainUI = new UI_RunDirectionArrow();
      ...
      public static function get instance() : RunDirectionArrow
      {
         if(_instance == null)
         {
            _instance = new RunDirectionArrow();
         }
         return _instance;
      }
