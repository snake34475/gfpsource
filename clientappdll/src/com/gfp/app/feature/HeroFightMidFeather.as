package com.gfp.app.feature
{
   ...
   public class HeroFightMidFeather
   {
      ...
      public function HeroFightMidFeather()
      {
         super();
         this.init();
         this.addEvent();
      ...
      private function init() : void
      {
         ...
         var _loc1_:Array = PvpEntry.instance.fightReadyInfo.roles;
      ...
      private function onKeyDown(param1:KeyboardEvent) : void
      {
         ...
         {
            SocketConnection.send(CommandID.FIGHT_ACTIVITY_EFFECT,2,1103,_loc2_);
      ...
      private function onFightWinner(param1:FightEvent) : void
      {
         ...
         {
            AlertManager.showSimpleAlarm("恭喜你赢得了本场群英争霸胜利，获得了10点功勋！");
         }
         else
         {
            AlertManager.showSimpleAlarm("你和你的小伙伴战胜了魔王，赢得了胜利，获得了10点功勋！");
         }
      }
      ...
      private function onFightFail(param1:FightEvent) : void
      {
         if(this.bossID == MainManager.actorInfo.userID)
         {
            AlertManager.showSimpleAlarm("你被打败了，请下次再接再厉吧");
         }
         else
         {
            AlertManager.showSimpleAlarm("你和你的小伙伴被魔王打败了，请下次再接再厉吧。");
         }
      }
